...
class ObservableNotifications {
    ...
    static let NOTIFICATION_WINDOW_MAIN_OPEN = Notification.Name("NOTIFICATION_WINDOW_MAIN_OPEN")
    static let NOTIFICATION_WINDOW_MAIN_CLOSE = Notification.Name("NOTIFICATION_WINDOW_MAIN_CLOSE")
    
    static let NOTIFICATION_SEGMENT_CHANGED = Notification.Name("NOTIFICATION_SEGMENT_CHANGED")

//    static let NOTIFICATION_SEGMENT_PERSONAL = Notification.Name("NOTIFICATION_SEGMENT_PERSONAL")
//    static let NOTIFICATION_SEGMENT_TEAM = Notification.Name("NOTIFICATION_SEGMENT_TEAM")
//    static let NOTIFICATION_SEGMENT_DELEGATION = Notification.Name("NOTIFICATION_SEGMENT_DELEGATION")
